      ...
      <div class="box box-default">
       ...
       <!--   <h6 class="card-subtitle">Bootstrap Form Validation check the <a href="http://reactiveraven.github.io/jqBootstrapValidation/">official website </a></h6> -->
        ...
        <div class="box-body">
          <div class="row">
            <div class="col">
            	<form action="admin_updateLocation.html" method="post" novalidate>
            	<c:forEach items="${ls}" var="q">
					<input type="hidden" name="locationId" value="${q.locationId}">
						<div class="form-group">
						<h5>location name <span class="text-danger">*</span></h5>
						<div class="controls">
							<input type="text" value="${q.locationName}" name="locationName" class="form-control" required data-validation-required-message="This field is required"> </div>
					...
					<div class="form-group">
						...
						<div class="controls">
							<input type="text" value="${q.locationDescription}" name="locationDescription" class="form-control" required data-validation-required-message="This field is required"> </div>
					<!-- 	<div class="form-control-feedback"><small>Add <code>required</code> attribute to field for required validation.</small></div> -->
					</div>
					</c:forEach>
