      ...
      <div class="box box-default">
       ...
       <!--   <h6 class="card-subtitle">Bootstrap Form Validation check the <a href="http://reactiveraven.github.io/jqBootstrapValidation/">official website </a></h6> -->
        ...
        <div class="box-body">
          <div class="row">
            <div class="col">
            	<form action="admin_addloca.html" method="post" novalidate>
					
										<div class="form-group">
						<h5>location name <span class="text-danger">*</span></h5>
						<div class="controls">
							<input type="text" name="locationName" class="form-control" required data-validation-required-message="This field is required"> </div>
					...
					<div class="form-group">
						...
						<div class="controls">
							<input type="text" name="locationDescription" class="form-control" required data-validation-required-message="This field is required"> </div>
					<!-- 	<div class="form-control-feedback"><small>Add <code>required</code> attribute to field for required validation.</small></div> -->
					</div>
