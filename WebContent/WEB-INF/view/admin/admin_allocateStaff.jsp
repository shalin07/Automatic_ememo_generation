     ...
     <!-- Basic Forms -->
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col">
            	<form action="admin_staffAllocation.html" method="post" novalidate>
					
					<div class="form-group">
						<h5>Location <span class="text-danger">*</span></h5>
						<div class="controls">
							<select name="selectLocation" id="select" required class="form-control">
								<option value="">Select location name</option>
								<c:forEach items="${locationlist}" var="x">
					...
					<div class="form-group">
						...
						<div class="controls">
							<select name="selectStaff" id="selectstaff" required class="form-control">
								<option value="">Select staff name</option>
							 	<c:forEach items="${stafflist}" var="y">
										<option>${y.firstName}</option>
					...
					<div class="form-group">
						<h5>Date assigned <span class="text-danger">*</span></h5>
						<div class="controls">
							<input type="date" name="dateAssigned" class="form-control" required data-validation-required-message="This field is required"> </div>
