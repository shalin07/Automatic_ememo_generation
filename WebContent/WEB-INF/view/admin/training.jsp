        ...
        <div class="box-body">
          <div class="row">
            <div class="col">
				...
				<input type="button" value="Start training" id="training_button" onclick="training()" />
...
<!-- ./wrapper -->
    ...
    function training()
	{
    	...
    	document.getElementById("training_button").value="Stop training";
		...
		htp.onreadystatechange = function()
		{
			if(htp.readyState==4)
			{
				...
				document.getElementById("training_button").value="Start training";
			}
		};
