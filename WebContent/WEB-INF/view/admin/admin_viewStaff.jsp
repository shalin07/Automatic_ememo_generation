...
<meta charset="utf-8">
    ...
    <title>Apro Admin - Dashboard  Data Tables</title>
              ...
              <table id="example1" class="table table-bordered table-striped table-responsive">
				...
				<tbody>
					...
					<tr>
						...
						<td>${x.password}</td>
						<td>${x.phoneNumber}</td>
						 <td> <a href="admin_editStaff.html?id=${x.staffID}"> Edit </a></td>
						<td> <a href="admin_deleteStaff.html?id=${x.staffID}"> Delete </a></td> 
					</tr>
					</c:forEach>
				</tbody>
				<tfoot>
